...
This example uses a compressed version of the ovenbird mistnetting data:
```{r settlementexample, eval = TRUE, cache = mycache}
ovenCHb <- reduce(ovenCHp, by = 'all', outputdetector = 'count')
msk <- make.mask(traps(ovenCH[[1]]), buffer = 500, spacing = 40, type = 'trapbuffer')
# uniform settlement
